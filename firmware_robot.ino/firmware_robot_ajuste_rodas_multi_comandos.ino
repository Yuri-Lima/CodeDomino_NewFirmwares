...
void leRfid() {
  ...
  for(int i =0;i<18 &&(instrucao != 0 || parametro != 0);i+=2){
    instrucao = block(i);
    parametro = block(i+1);
...
void executaProgramaX(int ponteiro) {
  int comando = programa[ponteiro];
  int parametro = parametros[ponteiro];
  ...
  if(comando!=0) { //não executa numericos
    ...
    int novoParametro = 0;
    while(parametros[ponteiroSeguinte]==0) { //procura as peças numéricas de parâmetro
      ponteiroSeguinte++;
      quantidNumericas++;
...
void esquerda(int direcao) {
  ...
  switch (passoEsq) {
    case 4:
      binarioEsq = B00001100;
      break;
    case 3:
      binarioEsq = B00000110;
      break;
    case 2:
      binarioEsq = B00000011;
      break;
    case 1:
      binarioEsq = B00001001;
      break;
    /*
    case 5:
...
void direita(int direcao) {
  ...
  switch (passoDir) {
    ...
    case 5:
      ...
      */
    case 1:
      binarioDir = B10010000;
      break;
    case 2:
      binarioDir = B11000000;
      break;
    case 3:
      binarioDir = B01100000;
      break;
    case 4:
      binarioDir = B00110000;
      break;
  }
}
